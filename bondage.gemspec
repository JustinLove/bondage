...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "LICENSE.txt", "Manifest.txt", "README.rdoc", "Rakefile", "lib/bondage.rb", "script/console", "script/destroy", "script/generate", "spec/bondage_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "synopsis.rb", "tasks/rspec.rake"]
  s.has_rdoc = true
